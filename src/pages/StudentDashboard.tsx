...
import StudentLearningTab from "../components/StudentDashboard/StudentLearningTab";
...
const StudentDashboard = () => {
  ...
  type Tab = "dashboard" | "my-learning" | "assignments" | "pronunciation" | "schedule" | "messages" | "settings";
  
  const [activeTab, setActiveTab] = useState<Tab>("dashboard");

  const NavItems: { tab: Tab; label: string; icon: JSX.Element }[] = [
    { tab: "dashboard", label: "Dashboard", icon: <Home size={22} /> },
    { tab: "my-learning", label: "My Learning", icon: <BookOpen size={22} /> },
  ...
  return (
    <div className="min-h-screen bg-white flex rounded-lg h-[100vh] max-h-[100vh]">
      {/* {loading && <Loading />} */}
      {/* Sidebar */}
      <motion.div
      ...
      >
        <div className="flex flex-col h-full">
          <div className="relative w-64 px-22 py-5 flex items-center gap-2 border-b-1 border-gray-200">
            ...
            <h2 className="whitespace-nowrap font-extrabold">Student</h2>
          </div>
      ...
      <div className="flex-1 flex flex-col h-[100vh] max-h-[100vh]">
        ...
        <main className="flex-1 overflow-y-auto bg-white">
          ...
          >
            {/* Learning Tab */}
            <StudentLearningTab Tab={() => (activeTab === "my-learning" ? "my-learning" : "")} />
            {/* // Schedule Tab */}
