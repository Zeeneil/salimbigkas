    ...
    return (
        <div className="flex items-center justify-between mb-2 py-2">
            <div className="flex items-center gap-2">
                ...
                <span className="font-extrabold mr-2" data-joyride="quiz-question-number">
                ...
                {(run || currentQuestion.image) && (
                    <motion.button
                        ...
                        whileHover={{ scale: 1.1 }}
                        whileTap={{ scale: 0.9 }}
                        data-joyride="quiz-question-image"
                    >
                        <Image size={24} />
                    </motion.button>
                )}
            ...
            <div className="flex items-center space-x-4">
                <div className="flex items-center space-x-2" data-joyride="quiz-score">
                ...
                <div className="flex items-center justify-center gap-2 relative" data-joyride="quiz-timer">
                    <motion.div
                        key={timeLeft}
                        className="relative"
                        initial={{ scale: 1 }}
            ...
            {openImage && currentQuestion.image && (
                <div className="fixed inset-0 bg-black/80 z-50 backdrop-blur-sm flex items-center justify-center" data-joyride="quiz-question-image">
                    <motion.button
                        type="button"
