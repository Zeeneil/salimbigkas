...
const Quizzes = () => {
  ...
  }, [formattedGradeLevel, navigate, role, setResults, setSelectedQuiz]);
          ...
          <div className="flex items-center py-4">
            <div className="w-1/4 flex items-center justify-center mx-6">
              <motion.button
                ...
                whileTap={{ scale: 0.95 }}
              >
                <img loading="lazy" src={imageSrc.lessThan} alt="Less Than" className="size-10"/>
              </motion.button>
            </div>
            ...
            <div className="w-1/4 flex items-center justify-center mx-6">
              <motion.button
                ...
                whileTap={{ scale: 0.95 }}
              >
                <img loading="lazy" src={imageSrc.greaterThan} alt="Greater Than" className="size-10" />
              </motion.button>
            </div>
          </div>
        )}
